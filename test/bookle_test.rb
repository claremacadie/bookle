...
class CMSTest < Minitest::Test
  ...
  def test_available_books_list_signed_in
    get "/paginated_books_list/available_to_borrow/0", {}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_available_books_list_signed_out
    get "/paginated_books_list/available_to_borrow/0"
    assert_equal 302, last_response.status
    assert_equal "You must be signed in to do that.", session[:message]
  ...
  def test_filtered_by_title_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 'k', author: ''}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_author_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: 'k'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_and_author_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 'a', author: 'a'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_category_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', category_id: '1'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_and_category_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 'k', author: '', category_id: '1'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_author_and_category_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: 'k', category_id: '1'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_available_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', available: 'availability', requested: '', on_loan: ''}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_requested_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', available: '', requested: 'availability', on_loan: ''}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', available: '', requested: '', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_available_and_requested_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', available: 'availability', requested: 'availability', on_loan: ''}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_available_and_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', available: 'availability', requested: '', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_requested_and_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', available: '', requested: 'availability', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_available_requested_and_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: '', available: 'availability', requested: 'availability', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_and_availability_is_available_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 't', author: '', available: 'availability', requested: '', on_loan: ''}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_author_and_availability_is_requested_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: '', author: 'k', available: '', requested: 'availability', on_loan: ''}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_and_availability_is_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 'k', author: '', available: '', requested: '', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_and_availability_is_available_and_requested_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 't', author: '', available: 'availability', requested: 'availability', on_loan: ''}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_and_availability_is_available_and_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 't', author: '', available: 'availability', requested: '', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_and_availability_is_requested_and_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 't', author: '', available: '', requested: 'availability', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_availability_is_available_requested_and_onloan_books_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 't', author: '', available: 'availability', requested: 'availability', on_loan: 'availability'}, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_by_title_author_category_and_availability_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 'o', author: 'o', category_id: '1', available: 'availability' }, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_books_no_book_found_list_signed_in
    get "/paginated_books_list/filter_results/0", {title: 'q', author: '' }, {"rack.session" => { user_name: "Clare MacAdie" , user_id: 1 } }
  ...
  def test_filtered_books_list_signed_out
    get "/paginated_books_list/filter_results/0"
