...
class CMSTest < Minitest::Test
  ...
  def user_2_session
    { "rack.session" => { user_name: "Clare MacAdie", user_id: 2 } }
  end

  def user_3_session
    { "rack.session" => { user_name: "Alice Allbright", user_id: 3 } }
  end

  def user_4_session
    { "rack.session" => { user_name: "Beth Bloom", user_id: 4 } }
  end
  ...
  def test_appropriate_hyperlinks_for_book_titles
    get "/books/filter_results/all_books/3", {}, user_2_session
  ...
  def test_all_books_list_signed_in
    get "/books/filter_results/all_books/0", {}, user_2_session
  ...
  def test_available_books_list_signed_in
    get "/books/filter_results/available_to_borrow/0", {}, user_2_session
  ...
  def test_available_books_list_signed_in_invalid_offset
    get "/books/filter_results/available_to_borrow/9", {}, user_2_session
  ...
  def test_view_your_books_signed_in
    get "/books/filter_results/your_books/0", {}, user_2_session
  ...
  def test_your_books_signed_in_invalid_offset
    get "/books/filter_results/your_books/9", {}, user_2_session
  ...
  def test_filter_books_form_signed_in
    get "/books/filter_form", {}, user_2_session
  ...
  def test_filter_books_form_signed_in_no_books_on_bookle
    get "/books/filter_results/your_books/0", {}, user_4_session
  ...
  def test_filter_books_signed_in_invalid_offset
    get "/books/filter_results/search/9", {title: '', author: 'k'}, user_2_session
  ...
  def test_filtered_by_title_books_list_signed_in_pagination_test
    get "/books/filter_results/search/0", {title: 'k', author: ''}, user_2_session
  ...
  def test_filtered_by_author_books_list_signed_in_pagination_test
    get "/books/filter_results/search/0", {title: '', author: 'k'}, user_2_session
  ...
  def test_filtered_by_author_books_list_signed_in_pagination_test
    get "/books/filter_results/search/3", {title: '', author: 'k'}, user_2_session
  ...
  def test_filtered_by_title_and_author_books_list_signed_in
    get "/books/filter_results/search/0", {title: 'a', author: 'a'}, user_2_session
  ...
  def test_filtered_by_category_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', category_id_1: '1'}, user_2_session
  ...
  def test_filtered_by_title_and_category_books_list_signed_in
    get "/books/filter_results/search/0", {title: 'k', author: '', category_id_1: '1'}, user_2_session
  ...
  def test_filtered_by_author_and_category_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: 'k', category_id_1: '1'}, user_2_session
  ...
  def test_filtered_by_availability_is_available_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', available: 'availability', requested: '', on_loan: ''}, user_2_session
  ...
  def test_filtered_by_availability_is_requested_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', available: '', requested: 'availability', on_loan: ''}, user_2_session
  ...
  def test_filtered_by_availability_is_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', available: '', requested: '', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_availability_is_available_and_requested_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', available: 'availability', requested: 'availability', on_loan: ''}, user_2_session
  ...
  def test_filtered_by_availability_is_available_and_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', available: 'availability', requested: '', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_availability_is_requested_and_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', available: '', requested: 'availability', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_availability_is_available_requested_and_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: '', available: 'availability', requested: 'availability', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_title_and_availability_is_available_books_list_signed_in
    get "/books/filter_results/search/0", {title: 't', author: '', available: 'availability', requested: '', on_loan: ''}, user_2_session
  ...
  def test_filtered_by_author_and_availability_is_requested_books_list_signed_in
    get "/books/filter_results/search/0", {title: '', author: 'k', available: '', requested: 'availability', on_loan: ''}, user_2_session
  ...
  def test_filtered_by_title_and_availability_is_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: 'k', author: '', available: '', requested: '', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_title_and_availability_is_available_and_requested_books_list_signed_in
    get "/books/filter_results/search/0", {title: 't', author: '', available: 'availability', requested: 'availability', on_loan: ''}, user_2_session
  ...
  def test_filtered_by_title_and_availability_is_available_and_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: 't', author: '', available: 'availability', requested: '', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_title_and_availability_is_requested_and_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: 't', author: '', available: '', requested: 'availability', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_availability_is_available_requested_and_onloan_books_list_signed_in
    get "/books/filter_results/search/0", {title: 't', author: '', available: 'availability', requested: 'availability', on_loan: 'availability'}, user_2_session
  ...
  def test_filtered_by_title_author_category_and_availability_list_signed_in
    get "/books/filter_results/search/0", {title: 'o', author: 'o', category_id_1: '1', available: 'availability' }, user_2_session
  ...
  def test_filtered_books_no_book_found_list_signed_in
    get "/books/filter_results/search/0", {title: 'q', author: '' }, user_2_session
  ...
  def test_view_available_book_signed_in_as_book_owner
    get "/books/filter_results/search/0", {title: 'Philosopher', author: '' }, user_2_session
  ...
  def test_view_requested_book_signed_in_as_book_owner
    get "/books/filter_results/search/0", {title: 'Chamber', author: '' }, user_2_session
  ...
  def test_view_requested_book_signed_in_as_book_requester
    get "/books/filter_results/search/0", {title: 'Chamber', author: '' }, user_3_session
  ...
  def test_view_onloan_book_signed_in_as_book_owner
    get "/books/filter_results/search/0", {title: 'Prisoner', author: '' }, user_2_session
  ...
  def test_view_onloan_book_signed_in_as_book_borrower
    get "/books/filter_results/search/0", {title: 'Prisoner', author: '' }, user_3_session
  ...
  def test_request_book
    post "/book/1/request", {}, user_3_session
  ...
  def test_cancel_request_book
    post "/book/2/cancel_request", {}, user_3_session
  ...
  def delete_book_not_signedin_not_as_book_owner
    post "/book/7/delete", { book_id: "7" }, user_3_session
    assert_equal 302, last_response.status
  ...
  def test_edit_book_signedin_as_not_book_owner
    get "/book/1/edit", {}, user_3_session
    assert_equal 302, last_response.status
    assert_equal "You must be the book owner to do that.", session[:message]
  end
